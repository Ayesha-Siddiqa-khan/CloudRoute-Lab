...
aws ssm get-parameter --name "/terrapilot/CloudRoute Lab/dev/kubernetes/join-command/public" --with-decryption --region "us-east-1" --query Parameter.Value --output text
```
